Feature: Carry_out_SEAD_mission_by_an_Interrupted_method_of_fire

#Make 2nd monitor as a main screen
  ...
  Scenario: Validating SEAD engagement times panel
    ...
    And User should enter the "Grid location, Altitude and Direction" on the target location section
      ...
      | Sup      | Sup  | 24SVJ 10205 85816  | textbox |       100,0 |                  |
      | Mark     | Mark | 24S VJ 10204 85803 | textbox |       100,0 |                  |
    ...
    And User select a "Method of Fire and control" Method of Fire and control
      ...
      | Interrupted | Interrupted |       | sclick  |         0,0 |             0.90 |
